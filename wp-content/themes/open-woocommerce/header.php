...
if (best_shop_get_setting('top_bar_left_content') === 'menu') {
    ...
    ?>
                    <ul>
                        ...
                        <li><?php echo esc_html(best_shop_get_setting('phone_title')) . esc_html(best_shop_get_setting('phone_number')); ?>
                        </li>
                        <?php endif;?>
                        <?php if (best_shop_get_setting('address') != ''): ?>
                        <li><?php echo esc_html(best_shop_get_setting('address_title')) . esc_html(best_shop_get_setting('address')); ?>
                        </li>
                        <?php endif;?>
                        <?php if (best_shop_get_setting('mail_description') != ''): ?>
                        <li><?php echo esc_html(best_shop_get_setting('mail_title')) . esc_html(best_shop_get_setting('mail_description')); ?>
                        </li>
                        <?php endif;?>
                    </ul>
                    <?php
...
?>
        ...
        <div
            class=" <?php if (best_shop_get_setting('menu_layout') === 'default') {echo 'main-menu-wrap';} else {echo 'burger-banner';}?> ">
            <div class="container">
